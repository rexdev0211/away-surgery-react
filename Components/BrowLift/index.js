...
export const BrowLift = () => {
  return (
    ...
    <div className="browlift">
                  ...
                  <div className="u-container-layout u-container-layout-1">
                    <div className="u-container-style u-expanded-width-xs u-group u-group-1">
                      <div className="u-container-layout u-valign-middle-lg u-valign-middle-xl u-container-layout-2">
                        <h4 className="u-align-center u-text u-text-custom-color-3 u-text-1"> Life is Good When Your Brows Are
                          On Point</h4>
                        <h2 className="u-align-center u-text u-text-default u-text-2"> Brow Lift</h2>
                        <p className="opacity_point75 u-align-center u-text u-text-3"> A brow lift procedure is most commonly
                          carried out to correct the signs of ageing, in which forehead creases and the descent of the brow
                          has caused a worn-out or aged look.<br />
                        </p>
      ...
      <section className="u-clearfix u-section-2" id="carousel_026f">
        <div className="u-clearfix u-sheet u-valign-top-sm u-valign-top-xs u-sheet-1">
          ...
          <div className="u-clearfix u-expanded-width u-gutter-0 u-layout-wrap u-layout-wrap-1">
            <div className="u-gutter-0 u-layout">
              <div className="u-layout-row">
                <div className="u-align-left u-container-style u-image u-layout-cell u-size-32 u-image-2" data-image-width={1210} data-image-height={1400}>
                  <div className="u-container-layout u-container-layout-1" />
                </div>
                <div className="u-align-left u-container-style u-layout-cell u-size-28 u-layout-cell-2">
                  <div className="u-container-layout u-valign-top-md u-valign-top-sm u-valign-top-xs u-container-layout-2">
                    <h4 className="u-text u-text-custom-color-3 u-text-default u-text-1"> What is Brow Lift?</h4>
                    <h2 className="u-text u-text-2"> Droopy eyebrows and deep wrinkles on your forehead.</h2>
                    <p className="u-text u-text-custom-color-5 u-text-default u-text-3"> Brow lifting is not just performed for
                      aesthetic reasons. In many cases, the drooping of the brow can affect vision and, therefore, a brow
                      lift procedure can significantly improve the lateral visual field.<br />
      ...
      <section className="u-clearfix u-section-3" id="sec-67b2">
          ...
          <div className="u-clearfix u-expanded-width u-gutter-8 u-layout-wrap u-layout-wrap-1">
            <div className="u-gutter-0 u-layout">
              <div className="u-layout-row">
                <div className="u-container-style u-layout-cell u-size-30-md u-size-30-sm u-size-30-xs u-size-32-lg u-size-32-xl u-layout-cell-1">
                  <div className="u-container-layout u-valign-middle-sm u-valign-middle-xs u-container-layout-1">
                    ...
                    <p className="u-align-left u-text u-text-custom-color-5 u-text-default-xs u-text-3"> It is not hard to be
                      eligible for a brow lift proce​dure. If you are reading this, you are probably a candidate!</p>
                    <h4 className="u-align-left u-text u-text-4"> You may be a good candidate for brow lift: </h4>
                      ...
                      <div className="u-repeater u-repeater-1">
                        <div className="u-container-style u-custom-item u-list-item u-repeater-item">
                          <div className="u-container-layout u-similar-container u-container-layout-2">
                            <img className="u-image u-image-default u-preserve-proportions u-image-1" src="images/img_27.png" data-image-width={147} data-image-height={150} />
                            <p className="u-align-left u-custom-font u-custom-item u-font-lato u-small-text u-text u-text-custom-color-5 u-text-variant u-text-5">
                              If you are looking for a way to get rid of your sagging eyebrows, deep forehead furrows,
                              pronounced wrinkles and frown lines over the eyes</p>
                          </div>
                        </div>
                        <div className="u-container-style u-custom-item u-list-item u-repeater-item">
                          <div className="u-container-layout u-similar-container u-container-layout-3">
                            <img className="u-image u-image-default u-preserve-proportions u-image-2" src="images/img_27.png" data-image-width={47} data-image-height={48} />
                            <p className="u-align-left u-custom-font u-custom-item u-font-lato u-small-text u-text u-text-custom-color-5 u-text-variant u-text-6">
                              If you want to achieve a more open and alert position to your eyes and face</p>
                          </div>
                        </div>
                        <div className="u-container-style u-custom-item u-list-item u-repeater-item">
                          <div className="u-container-layout u-similar-container u-container-layout-4">
                            <img className="u-image u-image-default u-preserve-proportions u-image-3" src="images/img_27.png" data-image-width={47} data-image-height={48} />
                            <p className="u-align-left u-custom-font u-custom-item u-font-lato u-small-text u-text u-text-custom-color-5 u-text-variant u-text-7">
                              If you are healthy</p>
                          </div>
                        </div>
                        <div className="u-container-style u-custom-item u-list-item u-repeater-item">
                          <div className="u-container-layout u-similar-container u-container-layout-5">
                            <img className="u-image u-image-default u-preserve-proportions u-image-4" src="images/img_27.png" data-image-width={47} data-image-height={48} />
                ...
                <div className="u-align-left u-container-style u-image u-image-contain u-layout-cell u-size-28-lg u-size-28-xl u-size-30-md u-size-30-sm u-size-30-xs u-image-5" data-image-width={656} data-image-height={864}>
      ...
      <section className="u-align-center u-clearfix u-section-4" id="carousel_5f1a">
        <div className="u-clearfix u-sheet u-sheet-1">
          ...
          <h2 className="u-text u-text-2"> The results of Brow Lift can be analyzed in two main</h2>
          <div className="u-clearfix u-expanded-width u-gutter-0 u-layout-wrap u-layout-wrap-1">
            <div className="u-gutter-0 u-layout">
              <div className="u-layout-row">
                  ...
                  <div className="u-container-layout u-valign-middle u-container-layout-1">
                    <div className="pink-border u-align-center-sm u-align-center-xs u-container-style u-expanded-width-lg u-expanded-width-md u-expanded-width-xl u-group u-shape-rectangle u-group-1">
                      <div className="u-container-layout u-valign-top-lg u-valign-top-md u-valign-top-sm u-valign-top-xs u-container-layout-2">
                        ...
                        <p className="u-align-left u-text u-text-custom-color-5 u-text-default-lg u-text-4">
                          <span className="u-text-custom-color-11" />A brow lift can address your cosmetic issues from the
                          eyes to the hairline.
                        </p>
                          ...
                          <div className="u-repeater u-repeater-1">
                            <div className="u-container-style u-custom-item u-list-item u-repeater-item">
                              <div className="u-container-layout u-similar-container u-container-layout-3">
                                ...
                                <p className="u-align-left u-custom-font u-custom-item u-font-lato u-small-text u-text u-text-custom-color-5 u-text-variant u-text-5">
                                  It improves the most visible signs of aging (deep wrinkles, furrows) around your eyes and
                                  forehead. </p>
                              </div>
                            </div>
                            <div className="u-container-style u-custom-item u-list-item u-repeater-item">
                              <div className="u-container-layout u-similar-container u-container-layout-4">
                                ...
                                <p className="u-align-left u-custom-font u-custom-item u-font-lato u-small-text u-text u-text-custom-color-5 u-text-variant u-text-6">
                                  Elevates your eyebrows by lifting the heaviness from your upper eyelids, creating a more
                                  vital, open, youthful, and alert look.</p>
                              </div>
                            </div>
                            <div className="u-container-style u-custom-item u-list-item u-repeater-item">
                              <div className="u-container-layout u-similar-container u-container-layout-5">
                                ...
                                <p className="u-align-left u-custom-font u-custom-item u-font-lato u-small-text u-text u-text-custom-color-5 u-text-variant u-text-7">
                                  You look younger and fresher. </p>
                              </div>
                            </div>
                            <div className="u-container-style u-custom-item u-list-item u-repeater-item">
                              <div className="u-container-layout u-similar-container u-container-layout-6">
                                ...
                                <p className="u-align-left u-custom-font u-custom-item u-font-lato u-small-text u-text u-text-custom-color-5 u-text-variant u-text-8">
                                  Your face is rejuvenated, and unwanted lines and sagging are eliminated. </p>
                              </div>
                            </div>
                          </div>
                        </div>
                  ...
                  <div className="u-container-layout u-valign-top-sm u-valign-top-xs u-container-layout-7">
                    <div className="pink-border u-align-center-sm u-align-center-xs u-container-style u-expanded-width-lg u-expanded-width-md u-expanded-width-xl u-group u-shape-rectangle u-group-2">
                      <div className="u-container-layout u-container-layout-8">
                        <img className="u-align-center u-image u-image-contain u-image-default u-image-6" data-image-width={160} data-image-height={160} src="images/img_75.png" />
                          ...
                          <div className="u-repeater u-repeater-2">
                            <div className="u-container-style u-custom-item u-list-item u-repeater-item">
                              <div className="u-container-layout u-similar-container u-container-layout-9">
                                <img className="u-image u-image-default u-preserve-proportions u-image-7" src="images/img_29.png" data-image-width={48} data-image-height={56} />
                                <p className="u-align-left u-custom-font u-custom-item u-font-lato u-small-text u-text u-text-custom-color-5 u-text-variant u-text-12">
                                  Expect Improved social, and self-confidence.</p>
                              </div>
                            </div>
                            <div className="u-container-style u-custom-item u-list-item u-repeater-item">
                            ...
                            <div className="u-container-style u-custom-item u-list-item u-repeater-item">
                              <div className="u-container-layout u-similar-container u-container-layout-13">
                                ...
                                <p className="u-align-left u-custom-font u-custom-item u-font-lato u-small-text u-text u-text-custom-color-5 u-text-variant u-text-16">
                                  Overall better quality of life</p>
                              </div>
                            </div>
                          </div>
                        </div>
      ...
      <section className="u-clearfix u-section-5" id="carousel_47ec">
        <div className="u-clearfix u-sheet u-valign-middle-md u-sheet-1">
          <div className="u-clearfix u-expanded-width u-gutter-10 u-layout-wrap u-layout-wrap-1">
            <div className="u-gutter-0 u-layout">
              <div className="u-layout-row">
                <div className="u-align-left u-container-style u-image u-image-contain u-layout-cell u-size-30-lg u-size-30-xl u-size-60-md u-size-60-sm u-size-60-xs u-image-1" data-image-width={1210} data-image-height={1594}>
                ...
                <div className="u-container-style u-layout-cell u-size-30-lg u-size-30-xl u-size-60-md u-size-60-sm u-size-60-xs u-layout-cell-2">
                  <div className="u-container-layout u-valign-middle u-container-layout-2">
                    <h4 className="text-align u-align-left u-text u-text-custom-color-3 u-text-1"> What to Do Before the Brow
                      Lift?</h4>
      ...
      <section className="u-clearfix u-section-6" id="sec-a96d">
        <div className="u-clearfix u-sheet u-sheet-1">
                  ...
                  <div className="u-layout-row">
                    ...
                    <div className="u-align-left u-container-style u-layout-cell u-right-cell u-size-30 u-layout-cell-2">
                      <div className="u-container-layout u-valign-middle-lg u-valign-middle-md u-valign-middle-xl u-valign-top-sm u-valign-top-xs u-container-layout-2">
                        ...
                        <p className="u-text u-text-custom-color-5 u-text-4"> Like all kinds of surgery, rhinoplasty requires
                          anesthesia. <br />
                  ...
                  <div className="u-layout-row">
                    <div className="u-align-left u-container-style u-layout-cell u-left-cell u-size-30 u-layout-cell-3" >
                      <div className="u-container-layout u-valign-middle u-container-layout-3">
                        ...
                        <p className="u-text u-text-custom-color-5 u-text-6"> The details of the surgery depend on the patients’
                          needs and the surgeon’s approach. So, this surgery is a customized procedure.<br />
                          <br />What’s suitable for you depends on your anatomical characteristics and your desired goals.<br />
                          <br />Your surgeon will help you to decide which surgical technique will best provide your cosmetic
                          goals. Our surgeons perform different brow lift techniques and most common ones are
                          classic/coronal and endoscopic brow lift.
                        </p>
                      </div>
                    </div>
          ...
          <div className="u-clearfix u-expanded-width u-gutter-10 u-layout-wrap u-layout-wrap-3">
            <div className="u-layout">
              <div className="u-layout-col">
                <div className="u-size-60">
                  <div className="u-layout-row">
                    <div className="u-container-style u-image u-image-contain u-layout-cell u-left-cell u-size-30 u-image-4" data-image-width={1128} data-image-height={1188}>
                    ...
                    <div className="u-align-left u-container-style u-layout-cell u-right-cell u-size-30 u-layout-cell-6">
                      <div className="u-container-layout u-valign-middle u-container-layout-6">
                        ...
                        <p className="u-text u-text-custom-color-5 u-text-8"> This technique is now out of fashion because there
                          are improvements with less invasive techniques, but, in some cases, it can be necessary to achieve
                          a patient’s desired goals. Via Coronal Brow Lift, a coronal incision, also known as headband
                          incision, is used behind the hairline, following from ear to ear. <br />
                          <br />The scars will not be visible. After the incision is made, the skin of the forehead is
                          elevated allowing to remove underlying tissue and to release the muscles. <br />
                          <br />Then, eyebrows are also elevated, excess skin is excised, and the source of visible creases
                          are smoothened to achieve a more youthful appearance. The incision is closed with sutures, clips,
                          or skin adhesives.
                        </p>
                      </div>
                    </div>
          ...
          <div className="u-clearfix u-expanded-width u-gutter-10 u-layout-wrap u-layout-wrap-4">
            <div className="u-layout">
              <div className="u-layout-col">
                <div className="u-size-60">
                  <div className="u-layout-row">
                    <div className="u-align-left u-container-style u-layout-cell u-left-cell u-size-30 u-layout-cell-7" >
                      <div className="u-container-layout u-valign-middle u-container-layout-7">
                        ...
                        <p className="u-text u-text-custom-color-5 u-text-10"> Using this method for brow lift surgeries is now
                          quite popular among plastic surgeons. It is less invasive which can often achieve equally desired
                          results when compared to previous techniques.<br />
                          <br />In this method, a series of short incisions (almost each less than an inch) are made within
                          the scalp and an endoscope (a pencil like thin tube with a camera) and a special instrument is
                          placed through one of the incisions.<br />
                          <br />This allows the surgeon to have a clear view when correcting and adjusting the muscles and
                          tissues beneath the skin. <br />
                          <br />Therefore, the surgeon can reposition the muscles, lift underlying tissues and remove excess
                          skin to achieve naturally lifted, smooth and youthful brows. Finally, the incisions are closed
                      ...
                      <div className="u-repeater u-repeater-1">
                        <div className="u-container-style u-custom-item u-list-item u-repeater-item">
                          <div className="u-container-layout u-similar-container u-container-layout-2">
                            ...
                            <p className="u-align-left u-custom-item u-text u-text-custom-color-5 u-text-5"> You will be seen in
                              the next few days for bandages and dressings or drain removal.</p>
                          </div>
                        </div>
                        <div className="u-container-style u-custom-item u-list-item u-repeater-item">
                          <div className="u-container-layout u-similar-container u-container-layout-3">
                            <img className="u-image u-image-default u-preserve-proportions u-image-2" src="images/img_30.png" data-image-width={48} data-image-height={48} />
                            <p className="u-align-left u-custom-item u-text u-text-custom-color-5 u-text-6"> When the dressings
                              are removed, you will be able to shower and wash your hair.</p>
                          </div>
                        </div>
                        <div className="u-container-style u-custom-item u-list-item u-repeater-item">
                          <div className="u-container-layout u-similar-container u-container-layout-4">
                            ...
                            <p className="u-align-left u-custom-item u-text u-text-custom-color-5 u-text-7"> Once all the
                              stitches or staples are removed, you can massage your scars when shampooing. </p>
                          </div>
                        </div>
                        <div className="u-container-style u-custom-item u-list-item u-repeater-item">
                          <div className="u-container-layout u-similar-container u-container-layout-5">
                            <img className="u-image u-image-default u-preserve-proportions u-image-4" src="images/img_30.png" data-image-width={48} data-image-height={48} />
                            <p className="u-align-left u-custom-item u-text u-text-custom-color-5 u-text-8"> Do not take
                        ...
                        <div className="u-container-style u-custom-item u-list-item u-repeater-item">
                          <div className="u-container-layout u-similar-container u-container-layout-6">
                            ...
                            <p className="u-align-left u-custom-item u-text u-text-custom-color-5 u-text-9"> Take pain
                              medication and antibiotics prescribed for you by your surgeon.</p>
                          </div>
                        </div>
                        <div className="u-container-style u-custom-item u-list-item u-repeater-item">
                          <div className="u-container-layout u-similar-container u-container-layout-7">
                            ...
                            <p className="u-align-left u-custom-item u-text u-text-custom-color-5 u-text-10"> You have to rest
                              and sleep with your head elevated.</p>
                          </div>
                        </div>
                        <div className="u-container-style u-custom-item u-list-item u-repeater-item">
                          <div className="u-container-layout u-similar-container u-container-layout-8">
                            ...
                            <p className="u-align-left u-custom-item u-text u-text-custom-color-5 u-text-11"> And don’t forget
                              to share photos of your new brows!</p>
                          </div>
                        </div>
                      </div>
                    </div>
                  ...
                  <div className="u-container-layout u-container-layout-9">
                    <div className="u-container-style u-group u-hidden-sm u-hidden-xs u-group-1">
                      <div className="u-container-layout">
                        <img className="u-image u-image-default u-preserve-proportions u-image-8" src="images/new_img_7.png" data-image-width={254} data-image-height={254} />
          ...
          <div className="u-align-center u-clearfix u-expanded-width u-gutter-0 u-layout-wrap u-layout-wrap-1">
            <div className="u-layout">
              <div className="u-layout-col">
                <div className="u-size-60">
                  <div className="u-layout-row">
                    <div className="u-container-style u-image u-image-contain u-layout-cell u-left-cell u-size-30 u-image-1" data-image-width={1440} data-image-height={1100}>
                      <div className="u-container-layout u-container-layout-1" />
                    </div>
              ...
              <div className="u-layout-col">
                <div className="u-size-60">
                  <div className="u-layout-row">
                    ...
                    <div className="u-container-style u-image u-image-contain u-layout-cell u-right-cell u-size-30 u-image-13" data-image-width={1440} data-image-height={1100}>
      ...
      <section className="u-clearfix u-section-11" id="sec-17cd">
        <div className="u-clearfix u-sheet u-sheet-1">
            ...
            <div className="u-gutter-0 u-layout">
              <div className="u-layout-row">
                ...
                <div className="u-align-center-lg u-align-center-md u-align-center-sm u-align-center-xs u-container-style u-layout-cell u-size-32 u-layout-cell-2">
                  <div className="u-container-layout u-valign-middle-lg u-valign-middle-md u-valign-middle-xl u-container-layout-14">
                    <h4 className="u-align-center-sm u-align-center-xs u-align-left-xl u-text u-text-custom-color-3 u-text-default-lg u-text-default-md u-text-default-sm u-text-default-xs u-text-13">
                      Our Pantients Say</h4>
                    <h2 className="text-align-center u-align-left-xl u-text u-text-14"> Don’t just take our word for it but
                      ...
                      <div className="u-carousel-inner" role="listbox">
                        <div className="u-active u-carousel-item u-container-style u-slide">
                          <div className="u-container-layout u-container-layout-15">
                            ...
                            <h3 className="u-align-center u-text u-text-default u-text-15"> Jane Harris</h3>
                            <p className="u-align-center u-text u-text-custom-color-3 u-text-default u-text-16"> Brow Lift</p>
                            <p className="u-align-left u-text u-text-custom-color-5 u-text-17"> Language can be a serious
                              problem when you choose to have plastic surgery abroad. I’ve seen many reviews complaining
                              about this. This is why you need to choose your clinic wisely. My surgeon and all the key
                              personnel of the clinic were speaking English fluently. </p>
                          </div>
                        </div>
                        <div className="u-carousel-item u-container-style u-slide">
                          <div className="u-container-layout u-container-layout-16">
                            ...
                            <h3 className="u-align-center-lg u-align-center-xl u-align-left-md u-align-left-sm u-align-left-xs u-text u-text-default u-text-18">
                              Gabriella Williams</h3>
                            <p className="u-align-center u-text u-text-custom-color-3 u-text-default u-text-19"> Brazilian Butt
                              Lift</p>
